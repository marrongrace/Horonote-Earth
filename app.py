...
t = {
    ...
    "disclaimer": "※1 Minor discrepancies in house degrees may occur due to calculation libraries or coordinate settings.",
    "TimeZone_tips": "※2 The time zone is automatically applied based on the latitude and longitude of the selected location.",
